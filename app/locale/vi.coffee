...
#    student_type_1: "Learn to program while playing an engaging game!"
    ...
    signup_as_student: "Tạo tài khoản học sinh"
    individuals_or_parents: "Cá nhân hoặc phụ huynh"
    individual_type: "For players learning to code outside of a class. Parents should sign up for an account here."
    signup_as_individual: "Đăng nhập với vai trò cá nhân"
    enter_class_code: "Nhập mã lớp"
    enter_birthdate: "Nhập ngày sinh của bạn:"
    parent_use_birthdate: "Các bậc phụ huynh ơi, hãy sử dụng ngày sinh của bạn."
    ask_teacher_1: "Hãy hỏi cô giáo cung cấp mã lớp cho bạn."
